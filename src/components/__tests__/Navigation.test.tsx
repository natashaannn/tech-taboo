...
describe('Navigation', () => {
  it('renders navigation links', () => {
    ...
    expect(screen.getByRole('link', { name: /card generator/i })).toBeInTheDocument()
  ...
  it('has correct link destinations', () => {
    ...
    const cardGeneratorLink = screen.getByRole('link', { name: /card generator/i })
    const manufacturerLink = screen.getByRole('link', { name: /manufacturer/i })
